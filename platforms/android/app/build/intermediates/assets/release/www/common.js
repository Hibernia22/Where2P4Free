...
var RestService = /** @class */ (function () {
    function RestService(http) {
        this.http = http;
        this.apiUrl = 'http://where2p4free.pythonanywhere.com/api';
        console.log('Hello RestServiceProvider Provider');
    }
    RestService.prototype.getLocations = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.apiUrl + "/findLocation").subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    RestService.prototype.addLocation = function (data) {
        var _this = this;
        console.log(data);
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.apiUrl + "/addLocation", JSON.stringify(data), httpOptions).subscribe(function (res) {
                resolve(res);
            }, function (err) {
                reject(err);
            });
